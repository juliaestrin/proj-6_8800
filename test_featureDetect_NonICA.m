...
feature_vec_train_NonICA_10s = [];
feature_vec_test_NonICA_10s = [];
...
% training for r01
for k = 1:N_test
    c1 = r01_train_10s.(strcat('ecg2_',num2str(k))); 
    c2 = r01_train_10s.(strcat('ecg3_',num2str(k)));
    c3 = r01_train_10s.(strcat('ecg4_',num2str(k)));
    c4 = r01_train_10s.(strcat('ecg5_',num2str(k)));
...
%     [num_peaks_c4, avg_spacing_c4, avg_peak_mag_c4] = featPeak(c4,fs);
    ...
    feature_vec_train_NonICA_10s(:,j) = ...
...
% r04
for k = 1:N_test
    c1 = r04_train_10s.(strcat('ecg2_',num2str(k))); 
    c2 = r04_train_10s.(strcat('ecg3_',num2str(k)));
    c3 = r04_train_10s.(strcat('ecg4_',num2str(k)));
    c4 = r04_train_10s.(strcat('ecg5_',num2str(k)));
...
% r07
for k = 1:N_test
    c1 = r07_train_10s.(strcat('ecg2_',num2str(k))); 
    c2 = r07_train_10s.(strcat('ecg3_',num2str(k)));
    c3 = r07_train_10s.(strcat('ecg4_',num2str(k)));
    c4 = r07_train_10s.(strcat('ecg5_',num2str(k)));
...
% r08
for k = 1:N_test
    c1 = r08_train_10s.(strcat('ecg2_',num2str(k))); 
    c2 = r08_train_10s.(strcat('ecg3_',num2str(k)));
    c3 = r08_train_10s.(strcat('ecg4_',num2str(k)));
    c4 = r08_train_10s.(strcat('ecg5_',num2str(k)));
...
% r10
for k = 1:N_test
    c1 = r10_train_10s.(strcat('ecg2_',num2str(k))); 
    c2 = r10_train_10s.(strcat('ecg3_',num2str(k)));
    c3 = r10_train_10s.(strcat('ecg4_',num2str(k)));
    c4 = r10_train_10s.(strcat('ecg5_',num2str(k)));
...
for k = N_test+1:N
    c1 = r01_test_10s.(strcat('ecg2_',num2str(k))); 
    c2 = r01_test_10s.(strcat('ecg3_',num2str(k)));
    c3 = r01_test_10s.(strcat('ecg4_',num2str(k)));
    c4 = r01_test_10s.(strcat('ecg5_',num2str(k)));
...
for k = N_test+1:N
    c1 = r04_test_10s.(strcat('ecg2_',num2str(k))); 
    c2 = r04_test_10s.(strcat('ecg3_',num2str(k)));
    c3 = r04_test_10s.(strcat('ecg4_',num2str(k)));
    c4 = r04_test_10s.(strcat('ecg5_',num2str(k)));
...
for k = N_test+1:N
    c1 = r07_test_10s.(strcat('ecg2_',num2str(k))); 
    c2 = r07_test_10s.(strcat('ecg3_',num2str(k)));
    c3 = r07_test_10s.(strcat('ecg4_',num2str(k)));
    c4 = r07_test_10s.(strcat('ecg5_',num2str(k)));
...
for k = N_test+1:N
    c1 = r08_test_10s.(strcat('ecg2_',num2str(k))); 
    c2 = r08_test_10s.(strcat('ecg3_',num2str(k)));
    c3 = r08_test_10s.(strcat('ecg4_',num2str(k)));
    c4 = r08_test_10s.(strcat('ecg5_',num2str(k)));
...
for k = N_test+1:N
    c1 = r10_test_10s.(strcat('ecg2_',num2str(k))); 
    c2 = r10_test_10s.(strcat('ecg3_',num2str(k)));
    c3 = r10_test_10s.(strcat('ecg4_',num2str(k)));
    c4 = r10_test_10s.(strcat('ecg5_',num2str(k)));
...
feature_vec_train_NonICA_10s_temp = feature_vec_train_NonICA_10s;
gold_vec_train_10s_temp = gold_vec_train_10s;

feature_vec_test_NonICA_10s_temp = feature_vec_test_NonICA_10s; 
gold_vec_test_10s_temp = gold_vec_test_10s; 

clear feature_vec_train_NonICA_10s gold_vec_train_10s feature_vec_test_NonICA_10s gold_vec_test_10s

[feature_vec_train_NonICA_10s,gold_vec_train_10s] = removeNans(feature_vec_train_NonICA_10s_temp,gold_vec_train_10s_temp); 
[feature_vec_test_NonICA_10s,gold_vec_test_10s] = removeNans(feature_vec_test_NonICA_10s_temp,gold_vec_test_10s_temp);

save("data_chunked_10s\feature_vec_train_NonICA_10s","feature_vec_train_NonICA_10s"); 
save("data_chunked_10s\feature_vec_test_NonICA_10s","feature_vec_test_NonICA_10s");
