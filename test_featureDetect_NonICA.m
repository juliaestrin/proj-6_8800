...
% training for r01
for k = 1:N_test
    c1 = r01_train_4s.(strcat('ecg2_',num2str(k))); 
    c2 = r01_train_4s.(strcat('ecg3_',num2str(k)));
...
% r04
for k = 1:N_test
    c1 = r04_train_4s.(strcat('ecg2_',num2str(k))); 
    c2 = r04_train_4s.(strcat('ecg3_',num2str(k)));
    c3 = r04_train_4s.(strcat('ecg4_',num2str(k)));
    c4 = r04_train_4s.(strcat('ecg5_',num2str(k)));
...
% r07
for k = 1:N_test
    c1 = r07_train_4s.(strcat('ecg2_',num2str(k))); 
    c2 = r07_train_4s.(strcat('ecg3_',num2str(k)));
    c3 = r07_train_4s.(strcat('ecg4_',num2str(k)));
    c4 = r07_train_4s.(strcat('ecg5_',num2str(k)));
...
% r08
for k = 1:N_test
    c1 = r08_train_4s.(strcat('ecg2_',num2str(k))); 
    c2 = r08_train_4s.(strcat('ecg3_',num2str(k)));
    c3 = r08_train_4s.(strcat('ecg4_',num2str(k)));
    c4 = r08_train_4s.(strcat('ecg5_',num2str(k)));
...
% r10
for k = 1:N_test
    c1 = r10_train_4s.(strcat('ecg2_',num2str(k))); 
    c2 = r10_train_4s.(strcat('ecg3_',num2str(k)));
    c3 = r10_train_4s.(strcat('ecg4_',num2str(k)));
    c4 = r10_train_4s.(strcat('ecg5_',num2str(k)));
...
for k = N_test+1:N
    c1 = r01_test_4s.(strcat('ecg2_',num2str(k))); 
    c2 = r01_test_4s.(strcat('ecg3_',num2str(k)));
    c3 = r01_test_4s.(strcat('ecg4_',num2str(k)));
    c4 = r01_test_4s.(strcat('ecg5_',num2str(k)));
...
for k = N_test+1:N
    c1 = r04_test_4s.(strcat('ecg2_',num2str(k))); 
    c2 = r04_test_4s.(strcat('ecg3_',num2str(k)));
    c3 = r04_test_4s.(strcat('ecg4_',num2str(k)));
    c4 = r04_test_4s.(strcat('ecg5_',num2str(k)));
...
for k = N_test+1:N
    c1 = r07_test_4s.(strcat('ecg2_',num2str(k))); 
    c2 = r07_test_4s.(strcat('ecg3_',num2str(k)));
    c3 = r07_test_4s.(strcat('ecg4_',num2str(k)));
    c4 = r07_test_4s.(strcat('ecg5_',num2str(k)));
...
for k = N_test+1:N
    c1 = r08_test_4s.(strcat('ecg2_',num2str(k))); 
    c2 = r08_test_4s.(strcat('ecg3_',num2str(k)));
    c3 = r08_test_4s.(strcat('ecg4_',num2str(k)));
    c4 = r08_test_4s.(strcat('ecg5_',num2str(k)));
...
for k = N_test+1:N
    c1 = r10_test_4s.(strcat('ecg2_',num2str(k))); 
    c2 = r10_test_4s.(strcat('ecg3_',num2str(k)));
    c3 = r10_test_4s.(strcat('ecg4_',num2str(k)));
    c4 = r10_test_4s.(strcat('ecg5_',num2str(k)));
