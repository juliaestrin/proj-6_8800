load("trainedModel_NN_noica_4.mat")
...
%%
%%
bpm_train = 60./gold_vec_train_4s;
bpm_test = 60./gold_vec_test_4s;

[bpm_train_z, mu_train, sigma_train] = zscore(bpm_train);
[bpm_test_z, mu_test, sigma_test] = zscore(bpm_test);


[rr_train_z, mu_rr_train, sigma_rr_train] = zscore(gold_vec_train_4s);
[rr_test_z, mu_rr_test, sigma_rr_test] = zscore(gold_vec_test_4s);

% 
%% TRAIN ON RR INTERVAL
trainPredictions_rr = trainedModel_NN.predictFcn(feature_vec_train_NonICA_4s);
...
trainRMSE_rr = rmse(trainPredictions_scaled_rr, gold_vec_train_4s');
...
testPredictions_rr = trainedModel_NN.predictFcn(feature_vec_test_NonICA_4s);
...
testRMSE_rr = rmse(testPredictions_scaled_rr, gold_vec_test_4s');
figure;
...
acc = summed/N;
%%
save("trainedModel_NN_noica_4", "trainedModel_NN");