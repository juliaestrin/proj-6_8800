...
t_chunk = 4; %Set chunk length for overlapping 
...
for i = 1:5
    for k=1:N_test*2
        ...
        r01_train_4s.(t_01) = t_chunk_01;
        r01_train_4s.(ecg_01) = ecg_chunk_01; 
        ...
        r04_train_4s.(t_04) = t_chunk_04;
        r04_train_4s.(ecg_04) = ecg_chunk_04; 
        ...
        r07_train_4s.(t_07) = t_chunk_07;
        r07_train_4s.(ecg_07) = ecg_chunk_07; 
        ...
        r08_train_4s.(t_08) = t_chunk_08;
        r08_train_4s.(ecg_08) = ecg_chunk_08;
        ...
        r10_train_4s.(t_10) = t_chunk_10;
        r10_train_4s.(ecg_10) = ecg_chunk_10; 
       
        if signum == 1
  
            t_Rpeak_01 = strcat('t_Rpeak','_',num2str(k));
            Rpeak_01 = strcat('Rpeak','_',num2str(k));
            r01_train_4s.(t_Rpeak_01) = t_chunk_Rpeak_01; 
            r01_train_4s.(Rpeak_01) = ecg_chunk_Rpeak_01;

            t_Rpeak_04 = strcat('t_Rpeak','_',num2str(k));
            Rpeak_04 = strcat('Rpeak','_',num2str(k));
            r04_train_4s.(t_Rpeak_04) = t_chunk_Rpeak_04; 
            r04_train_4s.(Rpeak_04) = ecg_chunk_Rpeak_04;
            
            t_Rpeak_07 = strcat('t_Rpeak','_',num2str(k));
            Rpeak_07 = strcat('Rpeak','_',num2str(k));
            r07_train_4s.(t_Rpeak_07) = t_chunk_Rpeak_07; 
            r07_train_4s.(Rpeak_07) = ecg_chunk_Rpeak_07;

            t_Rpeak_08 = strcat('t_Rpeak','_',num2str(k));
            Rpeak_08 = strcat('Rpeak','_',num2str(k));
            r08_train_4s.(t_Rpeak_08) = t_chunk_Rpeak_08; 
            r08_train_4s.(Rpeak_08) = ecg_chunk_Rpeak_08;


            t_Rpeak_10 = strcat('t_Rpeak','_',num2str(k));
            Rpeak_10 = strcat('Rpeak','_',num2str(k));
            r10_train_4s.(t_Rpeak_10) = t_chunk_Rpeak_10; 
            r10_train_4s.(Rpeak_10) = ecg_chunk_Rpeak_10;
...
for k = 1:N_test*2
    ...
    beat_01 = aveBeat_annotation(r01_train_4s.(var)); 
    beat_name_01 = strcat('gold_',num2str(k));
    r01_train_4s.(beat_name_01) = beat_01;

    beat_04 = aveBeat_annotation(r04_train_4s.(var)); 
    beat_name_04 = strcat('gold_',num2str(k));
    r04_train_4s.(beat_name_04) = beat_04;

    beat_07 = aveBeat_annotation(r07_train_4s.(var)); 
    beat_name_07 = strcat('gold_',num2str(k));
    r07_train_4s.(beat_name_07) = beat_07;

    beat_08 = aveBeat_annotation(r08_train_4s.(var)); 
    beat_name_08 = strcat('gold_',num2str(k));
    r08_train_4s.(beat_name_08) = beat_08;

    beat_10 = aveBeat_annotation(r10_train_4s.(var)); 
    beat_name_10 = strcat('gold_',num2str(k));
    r10_train_4s.(beat_name_10) = beat_10;
...
for i = 1:5
    for k=N_test*2+1:N*2
        ...
        t_01 = strcat('t',num2str(signum),'_',num2str(k));
        ecg_01 = strcat('ecg',num2str(signum),'_',num2str(k));
        r01_test_4s.(t_01) = t_chunk_01;
        r01_test_4s.(ecg_01) = ecg_chunk_01; 

        [t_chunk_04,ecg_chunk_04,t_chunk_Rpeak_04,ecg_chunk_Rpeak_04] = chunk_ecg(t_start,t_end,t_r04(:,i),ecg_r04_filt(:,i),t_anno_04); 
        t_04 = strcat('t',num2str(signum),'_',num2str(k));
        ecg_04 = strcat('ecg',num2str(signum),'_',num2str(k));
        r04_test_4s.(t_04) = t_chunk_04;
        r04_test_4s.(ecg_04) = ecg_chunk_04; 

        [t_chunk_07,ecg_chunk_07,t_chunk_Rpeak_07,ecg_chunk_Rpeak_07] = chunk_ecg(t_start,t_end,t_r07(:,i),ecg_r07_filt(:,i),t_anno_07); 
        t_07 = strcat('t',num2str(signum),'_',num2str(k));
        ecg_07 = strcat('ecg',num2str(signum),'_',num2str(k));
        r07_test_4s.(t_07) = t_chunk_07;
        r07_test_4s.(ecg_07) = ecg_chunk_07; 

        [t_chunk_08,ecg_chunk_08,t_chunk_Rpeak_08,ecg_chunk_Rpeak_08] = chunk_ecg(t_start,t_end,t_r08(:,i),ecg_r08_filt(:,i),t_anno_08); 
        t_08 = strcat('t',num2str(signum),'_',num2str(k));
        ecg_08 = strcat('ecg',num2str(signum),'_',num2str(k));
        r08_test_4s.(t_08) = t_chunk_08;
        r08_test_4s.(ecg_08) = ecg_chunk_08; 

        [t_chunk_10,ecg_chunk_10,t_chunk_Rpeak_10,ecg_chunk_Rpeak_10] = chunk_ecg(t_start,t_end,t_r10(:,i),ecg_r10_filt(:,i),t_anno_10); 
        t_10 = strcat('t',num2str(signum),'_',num2str(k));
        ecg_10 = strcat('ecg',num2str(signum),'_',num2str(k));
        r10_test_4s.(t_10) = t_chunk_10;
        r10_test_4s.(ecg_10) = ecg_chunk_10; 
        ...
        if signum == 1
            ...
            t_Rpeak_01 = strcat('t_Rpeak','_',num2str(k));
            Rpeak_01 = strcat('Rpeak','_',num2str(k));
            r01_test_4s.(t_Rpeak_01) = t_chunk_Rpeak_01; 
            r01_test_4s.(Rpeak_01) = ecg_chunk_Rpeak_01;

            t_Rpeak_04 = strcat('t_Rpeak','_',num2str(k));
            Rpeak_04 = strcat('Rpeak','_',num2str(k));
            r04_test_4s.(t_Rpeak_04) = t_chunk_Rpeak_04; 
            r04_test_4s.(Rpeak_04) = ecg_chunk_Rpeak_04;

            t_Rpeak_07 = strcat('t_Rpeak','_',num2str(k));
            Rpeak_07 = strcat('Rpeak','_',num2str(k));
            r07_test_4s.(t_Rpeak_07) = t_chunk_Rpeak_07; 
            r07_test_4s.(Rpeak_07) = ecg_chunk_Rpeak_07;

            t_Rpeak_08 = strcat('t_Rpeak','_',num2str(k));
            Rpeak_08 = strcat('Rpeak','_',num2str(k));
            r08_test_4s.(t_Rpeak_08) = t_chunk_Rpeak_08; 
            r08_test_4s.(Rpeak_08) = ecg_chunk_Rpeak_08;

            t_Rpeak_10 = strcat('t_Rpeak','_',num2str(k));
            Rpeak_10 = strcat('Rpeak','_',num2str(k));
            r10_test_4s.(t_Rpeak_10) = t_chunk_Rpeak_10; 
            r10_test_4s.(Rpeak_10) = ecg_chunk_Rpeak_10;
...
for k = N_test*2+1:N*2
    ...
    var = strcat('t_Rpeak_',num2str(k));
    beat_01 = aveBeat_annotation(r01_test_4s.(var)); 
    beat_name_01 = strcat('gold_',num2str(k));
    r01_test_4s.(beat_name_01) = beat_01;

    var = strcat('t_Rpeak_',num2str(k));
    beat_04 = aveBeat_annotation(r04_test_4s.(var)); 
    beat_name_04 = strcat('gold_',num2str(k));
    r04_test_4s.(beat_name_04) = beat_04;

    var = strcat('t_Rpeak_',num2str(k));
    beat_07 = aveBeat_annotation(r07_test_4s.(var)); 
    beat_name_07 = strcat('gold_',num2str(k));
    r07_test_4s.(beat_name_07) = beat_07;

    var = strcat('t_Rpeak_',num2str(k));
    beat_08 = aveBeat_annotation(r08_test_4s.(var)); 
    beat_name_08 = strcat('gold_',num2str(k));
    r08_test_4s.(beat_name_08) = beat_10;

    var = strcat('t_Rpeak_',num2str(k));
    beat_10 = aveBeat_annotation(r10_test_4s.(var)); 
    beat_name_10 = strcat('gold_',num2str(k));
    r10_test_4s.(beat_name_10) = beat_10;

end 

%% Save the chunked data 
save("data_chunked_4s\r01_train_4s","r01_train_4s"); 
save("data_chunked_4s\r04_train_4s","r04_train_4s");
save("data_chunked_4s\r07_train_4s","r07_train_4s");
save("data_chunked_4s\r08_train_4s","r08_train_4s");
save("data_chunked_4s\r10_train_4s","r10_train_4s");

save("data_chunked_4s\r01_test_4s","r01_test_4s"); 
save("data_chunked_4s\r04_test_4s","r04_test_4s");
save("data_chunked_4s\r07_test_4s","r07_test_4s");
save("data_chunked_4s\r08_test_4s","r08_test_4s");
save("data_chunked_4s\r10_test_4s","r10_test_4s");

save("data_chunked_4s\N","N")